...
function Graph(GID, timespan, group_by, where, lines, title) {
    ...
    this.get_graph = function () {
        if (this._graph) 
            return this._graph;
        var graph = {temp_GID: this.GID, live: false, data_type: cache["Graph"][GID], data: [], options: {bezierCurve: false, animation: false, scaleType: "date", useUtc: false, scaleShowLabels: true}};
