...
angular.module("overwatch", ['ui.bootstrap', 'ngRoute', 'ngTagsInput', 'ngMessages', 'ngCookies', 'googlechart', 'chart.js', 'ui.router', 'angularjs-autocomplete'])
    ...
    return {
        ...
        getUser : function() {
            if (getCookie("user") != "") {
                ...
                var user =  new User(temp_user["UID"], temp_user["first_name"], temp_user["last_name"], temp_user["email"], temp_user["wall_WID"]);
                console.log(user);
                return user;
            } else {
                return null;            
