...
wdini = [[0.843713278495887, 0.797619047619048, 0.754002911208151, 0.734090909090909, 0.680000000000000, 0.615384615384615],
         [0.156286721504113, 0.144841269841270, 0.189228529839884,
             0.181818181818182, 0.176000000000000, 0.205128205128205],
         [0.000000000000000, 0.057539682539683, 0.043668122270742,
             0.061363636363636, 0.120000000000000, 0.102564102564103],
         [0.000000000000000, 0.000000000000000, 0.013100436681223,
          0.020454545454546, 0.008000000000000, 0.051282051282051],
         [0.000000000000000, 0.000000000000000, 0.000000000000000,
          0.002272727272727, 0.008000000000000, 0.000000000000000],
         [0.000000000000000, 0.000000000000000, 0.000000000000000,
          0.000000000000000, 0.008000000000000, 0.025641025641026],
...
weini = [[0.828924162257496, 0.767661691542289, 0.676342525399129, 0.675675675675676, 0.546875000000000, 0.666666666666667],
         [0.171075837742504, 0.161194029850746, 0.210449927431060,
             0.207207207207207, 0.250000000000000, 0.138888888888889],
         [0.000000000000000, 0.071144278606965, 0.094339622641509,
             0.092342342342342, 0.109375000000000, 0.111111111111111],
         [0.000000000000000, 0.000000000000000, 0.018867924528302,
          0.015765765765766, 0.078125000000000, 0.027777777777778],
         [0.000000000000000, 0.000000000000000, 0.000000000000000,
          0.009009009009009, 0.000000000000000, 0.055555555555556],
         [0.000000000000000, 0.000000000000000, 0.000000000000000,
          0.000000000000000, 0.015625000000000, 0.000000000000000],
         [0.000000000000000, 0.000000000000000, 0.000000000000000, 0.000000000000000, 0.000000000000000, 0.000000000000000]]
...
def OccupanceSim(iResidents: int, bWeekend: bool):
    ...
    if bWeekend == False:
      # print "I am true"
        if iResidents == 1:
            transprob = datadir + '/wd1.csv'
        elif iResidents == 2:
            transprob = datadir + '/wd2.csv'
        elif iResidents == 3:
            transprob = datadir + '/wd3.csv'
        elif iResidents == 4:
            transprob = datadir + '/wd4.csv'
        elif iResidents == 5:
            transprob = datadir + '/wd5.csv'
    elif bWeekend == True:
        if iResidents == 1:
            transprob = datadir + '/we1.csv'
        elif iResidents == 2:
            transprob = datadir + '/we2.csv'
        elif iResidents == 3:
            transprob = datadir + '/we3.csv'
        elif iResidents == 4:
            transprob = datadir + '/we4.csv'
        elif iResidents == 5:
            transprob = datadir + '/we5.csv'
